  ...
  return (
    <div className="w-64 bg-black border-r border-gray-900 flex flex-col p-4 font-mono">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-3xl font-bold text-terminal-orange tracking-wider" style={{ textShadow: '0 0 10px rgba(255, 136, 0, 0.5)' }}>MORSE CHAT</h1>
      </div>
      ...
      <div className="mb-6">
        ...
        />
        <div className="text-center text-3xl font-bold text-terminal-orange mt-3" style={{ textShadow: '0 0 10px rgba(255, 136, 0, 0.5)' }}>
          {wpm}
        </div>
      </div>
